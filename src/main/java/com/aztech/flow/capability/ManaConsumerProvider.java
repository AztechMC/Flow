...
public class ManaConsumerProvider implements ICapabilitySerializable<NBTBase> {
    @CapabilityInject(IManaConsumer.class)
    public static final Capability<IManaConsumer> CAPABILITY = null;

    private IManaConsumer instance = CAPABILITY.getDefaultInstance();
